        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                const Text("AI Pot Hole", style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.white)),
                const Text("Pendeteksi kerusakan jalan", style: TextStyle(fontSize: 16, color: Colors.white70)),
